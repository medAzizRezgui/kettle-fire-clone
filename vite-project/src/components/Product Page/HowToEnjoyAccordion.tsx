...
const HowToEnjoyAccordion = () => {
  return (
    <>
      ...
      <Accordion allowToggle={true} my={"20px"} display={{ md: "none" }}>
        <AccordionItem border={"none"}>
          ...
          <AccordionPanel pb={4}>
            Organic Chicken Bone Broth (water, organic chicken bones, organic
            onions, organic carrots, organic fennel, organic leeks, organic
            apple cider vinegar, organic thyme, organic shiitake mushroom,
            organic tamarind extract, organic bay leaf), Organic Vegetable Broth
            (organic celery, organic green pepper, organic onion, organic
            carrot, organic garlic, organic scallions, organic tomato , organic
            parsley, organic thyme, organic rosemary, organic basil, organic
            spices), Sea Salt.
          </AccordionPanel>
        </AccordionItem>
      </Accordion>
